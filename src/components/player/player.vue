...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      // 获取初始位置和缩放
      _getPosAndScale () {
        const targetWidth = 40 // 迷你播放器图片宽度
        const paddingLeft = 40 // 迷你播放器图片中心离屏幕左边缘距离
        const paddingBottom = 30 // 迷你播放器图片中心离屏幕底部距离
        const paddingTop = 80 // 主播放器离顶部距离
        const width = window.innerWidth * 0.8 // 主播放器宽度
